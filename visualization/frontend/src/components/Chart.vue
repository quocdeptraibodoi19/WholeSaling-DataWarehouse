<template>
  <div
    class="flex flex-col items-start gap-3 border border-border bg-white p-4 rounded-2xl border-solid h-[400px]"
  >
    <div class="flex justify-between items-center self-stretch">
      <div
        class="text-text [font-family:Figtree] text-xl font-semibold leading-8"
      >
        {{ chartName }}
    ...
    <div
      class="flex justify-center items-center self-stretch"
