...
with DAG(
    ...
    sources = [
            ConstantsProvider.get_Ecomerce_source(), 
            # ConstantsProvider.get_HR_source(), 
            # ConstantsProvider.get_WholeSaling_source(), 
            # ConstantsProvider.get_Product_source()
        ]
    ...
    for source in sources:
        ...
        with TaskGroup(group_id=group_id, prefix_group_id=False) as task_group:
            ...
            source_groups.append(task_group)

    # with TaskGroup(group_id="Data_Firewall") as firewall_group:
        
    #     firewall_group >> source_groups